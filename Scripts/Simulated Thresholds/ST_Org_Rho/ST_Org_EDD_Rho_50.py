...
model_name = "n50N400m20l5" #samme modell
logdir = Path("tensorboard_logs", f"{current_file}_50") #trent på rho 0.7 data
print(logdir)
...
plt.grid(True)
plt.legend(['NN', 'CUSUM', 'Logit', 'Smart CUSUM'])
plt.savefig(f"Figures/ST_Org_EDD_Rho_50_3000run.png")
plt.tight_layout()
#plt.show()
