...
plt.subplot(2, 2, 1)
plt.plot(false_alarm_rates, average_delay, 'o-', linewidth=1.5, markersize=3, color='blue')
...
plt.plot(false_alarm_rates, fn, 'o-', linewidth=1.5, markersize=3, color='yellow')
