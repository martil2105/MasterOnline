...
model_name = "n15N400m12l5" #modell navn fra tensorboard, "vindu,antall serier trent på, bredde på NN, layers"
logdir = Path("tensorboard_logs", f"{current_file}_15") 
...
plt.grid(True)
plt.legend(['NN', 'CUSUM', 'Logit', 'Smart CUSUM'])
plt.savefig(f"Figures/ST_Org_EDD_Normal_15_3000run.png")
plt.tight_layout()
#plt.show() 
