...
model_name = "n100N400m24l5" #erier trent på, bredde på NN, layers"
...
data = GenDataMeanARH(num_repeats, stream_length, cp=None, mu=(mu_L, mu_L), coef=rhos, scale=scale)  #generer null data
...
result_alt =  DataGenAlternative( #data med changepoint og autokorrelasjon
                ...
                tau_bound=tau_bound,
                B_bound=B_bound,
                ar_model="ARH",#autokorrelasjon ar0
                scale=scale,
                sigma=sigma
